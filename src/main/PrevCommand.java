...
public class PrevCommand extends Command {
    ...
    public static ObjectNode createPrevOutput(final PrevCommand prevCommand, PlayerStatus player, boolean loaded) {
        ...
        if (!loaded || player.getRemainedTime() < 0) {
            ...
            output.put("message", "Returned to previous track successfully. The current track is " + player.getCurrentTrack() + ".");
        }
        return output;
    }
}
