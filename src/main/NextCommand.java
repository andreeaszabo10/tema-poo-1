...
public class NextCommand extends Command {
    ...
    public static ObjectNode createNextOutput(final NextCommand nextCommand, PlayerStatus player, boolean loaded) {
        ...
        if (!loaded || player.getRemainedTime() < 0) {
            ...
            output.put("message", "Skipped to next track successfully. The current track is " + player.getCurrentTrack() + ".");
        }
        return output;
    }
}
